...
function animate() {
  ...
  if (frameCount % 6 === 0) {
    ...
    if (state === 0) {
      ...
      elSignal.style.width = (6 + Math.random() * 4) + '%';
      elDot.style.background = '#00ffc8';
      elDot.style.boxShadow = '0 0 6px #00ffc8';
    } else if (state === 1) {
      ...
      elAxon.style.width = Math.max(0, 100 - pct) + '%';
